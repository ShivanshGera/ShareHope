    ...
    <div className="home-page">
      <section className="hero-section">
        <div className="hero-content">
          ...
          >
            ShareHope connects restaurants and NGOs through a focused,
      ...
      <section className="section-block split-block" id="about">
        <div>
          <span className="eyebrow">Why ShareHope</span>
      ...
      <section className="section-block testimonial-section">
        <div className="testimonial-copy">
          ...
          <p>
            ...
            clear operational dashboards help ShareHope feel ready for
        ...
        <div className="quote-card">
          ...
          <p>
            “ShareHope turns a simple CRUD flow into a focused food rescue
